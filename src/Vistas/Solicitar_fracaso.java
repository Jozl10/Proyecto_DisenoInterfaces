 ...
 * @author jozl2
 */
public class Solicitar_fracaso extends javax.swing.JFrame {
   ...
   public int contador=0;
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/pexels-ketut-subiyanto-4560087-removebg-preview.png"))); // NOI18N

        jLabel1.setFont(new java.awt.Font("SansSerif", 0, 24)); // NOI18N
        jLabel1.setText("Error de solicitud.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Solicitar_fracaso.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Solicitar_fracaso().setVisible(true);
            }
        });
    }
