 ...
 * @author jozl2
 */
public class Actualizar_exito extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/pexels-ivan-samkov-4240503-removebg-preview.png"))); // NOI18N

        jLabel1.setFont(new java.awt.Font("SansSerif", 0, 24)); // NOI18N
        jLabel1.setText("Solicitud actualizada con éxito.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Actualizar_exito.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Actualizar_exito().setVisible(true);
            }
        });
    }
