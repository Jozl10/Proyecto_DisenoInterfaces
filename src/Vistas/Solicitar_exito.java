 ...
 * @author jozl2
 */
public class Solicitar_exito extends javax.swing.JFrame {
   ...
   public int contador=0;
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/pexels-andrea-piacquadio-3769021-removebg-preview.png"))); // NOI18N

        jLabel1.setFont(new java.awt.Font("SansSerif", 0, 24)); // NOI18N
        jLabel1.setText("Solicitud enviada con éxito.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Solicitar_exito.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Solicitar_exito().setVisible(true);
            }
        });
    }
